...
import { AUTH_ABSOLUTE_PATH, QNA_LIST_ABSOLUTE_PATH, QNA_UPDATE_ABSOLUTE_PATH, QNA_WRITE_ABSOLUTE_PATH } from "src/constant";
...
export default function QnADetail() {
    ...
    const getBoardResponse = (result: ResponseDto | GetBoardResponseDto | null) => {
        const message = 
            !result ? '서버에 문제가 있습니다.' :
            result.code === 'VF' ? '잘못된 접수번호입니다.' :
            result.code === 'AF' ? '인증에 실패했습니다.' :
