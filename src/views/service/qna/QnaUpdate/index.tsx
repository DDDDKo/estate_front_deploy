...
import { QNA_DETALE_ABSOLUTE_PATH, QNA_LIST_ABSOLUTE_PATH } from 'src/constant';
...
export default function QnaUpdate() {
    ...
    const putBoardResponse = (result: ResponseDto | null) => {
        ...
        navigator(QNA_DETALE_ABSOLUTE_PATH(receptionNumber))
    };
    ...
    useEffect(() => {
        ...
        if (!loginUserRole ||!loginUserId ) return;
