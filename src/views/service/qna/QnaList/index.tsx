...
import { AUTH_ABSOLUTE_PATH, COUNT_PER_PAGE, COUNT_PER_SECTION, QNA_DETALE_ABSOLUTE_PATH, QNA_WRITE_ABSOLUTE_PATH } from 'src/constant';
...
function ListItem ({ 
    ...
    //                    event handler                    //
    const onClickHandler = () => navigator(QNA_DETALE_ABSOLUTE_PATH(receptionNumber));
