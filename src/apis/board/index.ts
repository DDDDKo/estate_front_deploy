...
export const postCommentRequest = async(receptionNumber: string | number, requestBody: PostCommentRequestDto, accessToken: string) => {
...
export const getBoardRequest = async(receptionNumber: string | number, accessToken: string) => {
...
// function : Q&A 게시물 수정API 함수  //
export const putBoardRequest = async(receptionNumber: string| number, requestBody: PutBoardRequestDto , accessToken: string) => {
...
export const increaseViewCountRequest = async(receptionNumber: string | number, accessToken: string) => {
...
export const deleteBoardRequest = async(receptionNumber: string | number, accessToken: string) => {
